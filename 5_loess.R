...
setwd("C:/Users/travi/Desktop/Genetics/TJH GxE Manuscript/loess")
...
write.csv(gdd_trans_ISU16,"C:/Users/travi/Desktop/TJH GxE Manuscript/loess/gdd_trans_ISU16.csv", row.names = TRUE)

gdd_trans_UMN16 <- predict(loessMod10_UMN16, data.frame(gdd_cmtv = seq(1, 1640, 1)), se = FALSE)
write.csv(gdd_trans_UMN16,"C:/Users/travi/Desktop/TJH GxE Manuscript/loess/gdd_trans_UMN16.csv", row.names = TRUE)

gdd_trans_ISU17 <- predict(loessMod10_ISU17, data.frame(gdd_cmtv = seq(1, 2155, 1)), se = FALSE)
write.csv(gdd_trans_ISU17,"C:/Users/travi/Desktop/TJH GxE Manuscript/loess/gdd_trans_ISU17.csv", row.names = TRUE)
