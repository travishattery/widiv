...
# Store results
write.csv(metab_est,"C:/Users/travi/Desktop/Genetics/TJH GxE Manuscript/2_Heatmaps/spearman_est_3env.csv", row.names = TRUE)
write.csv(metab_p,"C:/Users/travi/Desktop/Genetics/TJH GxE Manuscript/2_Heatmaps/spearman_p_3env.csv", row.names = TRUE)
